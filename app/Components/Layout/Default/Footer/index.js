      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-md-4 col-lg-4">
            <img className="w-50" src="https://numology.com/img/logo4.png" alt="" />
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 text-white">
            ...
            <div className="d-flex flex-column">
              <Link className="text-white" to="/chinh-sach-bao-mat">Chính sách bảo mật</Link>
              <Link className="text-white" to="dieu-khoan-su-dung">Điều khoản sử dụng</Link>
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 text-white mt-3">
            ...
            <li>158 Nguyễn Thị Nhung, KĐT Vạn Phúc, Hiệp Bình Phước, TP.Thủ Đức</li>
